...
class User:
    ...
    def get_by_email(cls, formulario):
        ...
        #}
        query = "SELECT * FROM users WHERE email = %(email)s"
        result = connectToMySQL('impresion3D').query_db(query, formulario) #Los SELECT regresan una lista
    ...
    def get_by_id(cls, formulario):
        ...
        result = connectToMySQL('impresion3D').query_db(query, formulario) #RECIBIMOS UNA LISTA
